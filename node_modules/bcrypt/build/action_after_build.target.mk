...
/var/www/html/medicalApp/node_modules/bcrypt/lib/binding/bcrypt_lib.node: TOOLSET := $(TOOLSET)
/var/www/html/medicalApp/node_modules/bcrypt/lib/binding/bcrypt_lib.node: $(builddir)/bcrypt_lib.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += /var/www/html/medicalApp/node_modules/bcrypt/lib/binding/bcrypt_lib.node
binding_gyp_action_after_build_target_copies = /var/www/html/medicalApp/node_modules/bcrypt/lib/binding/bcrypt_lib.node
